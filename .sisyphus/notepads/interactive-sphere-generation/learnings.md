# Learnings - Interactive Sphere Generation
...
- Used `teleop_xr.ik.loader.load_robot_class` to support various robot
  specifications.
- Export logic correctly targets
  `teleop_xr/ik/robots/assets/{robot_name}/sphere.json`.
