...
def main(
    ...
    default_export_path = os.path.join(asset_dir, "sphere.json")
    ...
    def on_export() -> None:
        if result:
            ...
            # Ensure radii are float for JSON serialization
            decomposition = {}
            ...
            logger.success(f"Successfully exported {result.num_spheres} spheres")
